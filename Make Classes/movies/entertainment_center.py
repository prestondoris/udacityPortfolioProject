...
harry_potter_prince = media.Movie("Harry Potter and the Half Blood Prince",
...
movies = [angels_demons, avatar, boondock_saints, braveheart, pitch_perfect, snatch, batman_begins, avengers, harry_potter_prince]
